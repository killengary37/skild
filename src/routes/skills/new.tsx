...
export const createSkillFn = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }) => {
    ...
    const { title, description, tags, installCommand, promptConfig, usageExample } = data;


    if (!userId) throw new Error("You must be signed in to publisha skill.")
...
function RouteComponent() {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      toast.success('Skill published successfully successfully');
